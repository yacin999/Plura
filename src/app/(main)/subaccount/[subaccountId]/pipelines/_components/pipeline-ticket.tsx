...
const PipelineTicket = ({setAllTickets, ticket, subaccountId, allTickets, index}: Props) => {
  ...
  const handleDeleteTicket = async () => {
    try {
      ...
      console.log("error from deleting the ticket !!", error)
    }
  }
  return (
    <Draggable
                  ...
                  <AlertDialog>
                    <DropdownMenu>
                      <Card className='my-4 dark:bg-slate-900 bg-white shadow-none transition-all'>
                          ...
                          <HoverCard>
                            <HoverCardTrigger asChild>
                              <div className='p-2 text-muted-foreground flex gap-2 hover:bg-muted transition-all rounded-lg cursor-pointer items-center'>
                                <LinkIcon/>
                                <span className='text-xs fond-bold'>CONTACT</span>
                              </div>
                            </HoverCardTrigger>
                        ...
                        <CardFooter className='m-0 p-2 border-top-[1px] border-muted-foreground/20 flex items-center justify-between'>
